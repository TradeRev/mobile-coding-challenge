...
struct R: Rswift.Validatable {
  ...
  struct reuseIdentifier {
    /// Reuse identifier `PhotoCellID`.
    static let photoCellID: Rswift.ReuseIdentifier<PhotoCell> = Rswift.ReuseIdentifier(identifier: "PhotoCellID")
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct main: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      func photoGridViewControllerID(_: Void = ()) -> PhotoGridViewController? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: photoGridViewControllerID)
      }
